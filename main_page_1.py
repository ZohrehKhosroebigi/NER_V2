...
for train_index, test_index in kfold.split(sent_idx_train.X_train):
    ...
    train_model.trainmodel(sent_idx_train.X_train[train_index], sent_idx_train.Y_train[train_index], None, None, LSTM_implement.model_, epoch=epoch, batch_size=bach_size)
    # evaluate the model
    evaluation=Evaluate_model()
